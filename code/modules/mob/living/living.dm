...
/mob/living/proc/fully_heal(heal_flags = HEAL_ALL)
	...
	if(heal_flags & HEAL_STAM)
		...
		/// SKYRAPTOR ADDITION BEGIN: Small tweaks to ensure stamina is reset
...
/mob/living/proc/extinguish_mob()
	/// SKYRAPTOR REMOVAL BEGIN: noextinguish is shitcode and we're not gonna tolerate it
...
/mob/living/vv_get_header()
	...
	"} /// SKYRAPTOR EDIT WITHIN: stamina rework
