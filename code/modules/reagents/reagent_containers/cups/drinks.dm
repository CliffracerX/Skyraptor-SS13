...
/obj/item/reagent_containers/cup/glass/waterbottle
	...
	//var/cap_icon = 'icons/obj/drinks/drink_effects.dmi' /// SKYRAPTOR REMOVAL
	//var/cap_icon_state = "bottle_cap_small" /// SKYRAPTOR REMOVAL
	//var/cap_on = TRUE /// SKYRAPTOR REMOVAL
	//var/cap_lost = FALSE /// SKYRAPTOR REMOVAL
	//var/mutable_appearance/cap_overlay /// SKYRAPTOR REMOVAL
	var/flip_chance = 10
