...
/obj/item
	...
	// Belt icon file, used to allow for new belt types added modularly or other custom shenanigans.
	...
	// For instance, greyscale_config_worn_bodytypes[BODYSHAPE_DIGITIGRADE] = /datum/greyscale_config/trek/worn_digi
