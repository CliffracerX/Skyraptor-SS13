/obj/item/storage/hypospraykit
	...
	icon = 'modular_skyraptor/modules/hyposprays/icons/hypokits.dmi'
...
/datum/greyscale_config/hypokit
	name = "Hypospray Kit"
	icon_file = 'modular_skyraptor/modules/hyposprays/icons/hypokits.dmi'
	json_config = 'modular_skyraptor/modules/hyposprays/greyscale/hypokit.json'
