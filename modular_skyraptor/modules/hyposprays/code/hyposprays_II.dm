...
/obj/item/hypospray/mkii
	...
	icon_state = "hypo2"
	icon = 'modular_skyraptor/modules/hyposprays/icons/hyposprays.dmi'
...
/obj/item/hypospray/mkii/proc/do_inject(mob/living/injectee, mob/living/user, mode)
	...
	playsound(loc, long_sound ? 'modular_skyraptor/modules/hyposprays/sound/hypospray_long.ogg' : pick('modular_skyraptor/modules/hyposprays/sound/hypospray.ogg','modular_skyraptor/modules/hyposprays/sound/hypospray2.ogg'), 50, 1, -1)
...
/datum/greyscale_config/hypospray_mkii
	name = "Hypospray Mk. II"
	icon_file = 'modular_skyraptor/modules/hyposprays/icons/hyposprays.dmi'
	json_config = 'modular_skyraptor/modules/hyposprays/greyscale/hypospray.json'
